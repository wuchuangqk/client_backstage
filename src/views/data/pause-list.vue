<template>
  <div class="app-page">
    ...
    <el-table v-loading="tableLoading" :data="tableData" :header-cell-style="_headerCellStyle" border
      ...
      <el-table-column label="结算金额(元)" prop="gmv" align="center" v-if="userId != 48 && userId != 58"></el-table-column>
      <el-table-column label="结算状态" prop="pay" align="center" v-if="userId != 48 && userId != 58">
